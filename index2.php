...
echo "<a class='nav-link' href='/index.php'>Les 10 dernieres chansons <span class='sr-only'></span></a></br>";
echo "<a class='nav-link' href='/index2.php'>Toute les chansons <span class='sr-only'></span></a>";
